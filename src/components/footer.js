    ...
    <div className="footer">
      ...
      <div className="footer__div">
        <div>
          <span>
            <a
              href="https://www.linkedin.com/in/soumya-ranjan-kalia/"
              target="_blank"
          ...
          <span>
            <a
              href="https://github.com/Soumyaranjankalia"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
          ...
          <span>
            <a
              href="https://twitter.com/kalia_soumya"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
